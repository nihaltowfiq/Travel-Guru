...
import { signInUserAcount, createUserAccount, handleFbSignIn, handleGoogleSignIn, initializeLoginFramework } from './AuthManager';
            ...
            <Row className="justify-content-md-center mt-3" >
                <Col md="auto">
                    <Form className='form-style'>
                        ...
                        {
                            newUser && <Form.Group onBlur={handleBlur} controlId="name">
                        ...
                        {
                            newUser && <Form.Group onBlur={handleBlur} controlId="confirmPassword">
